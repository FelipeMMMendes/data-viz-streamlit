...
df = pd.read_csv('https://raw.githubusercontent.com/FelipeMMMendes/data-viz-streamlit/refs/heads/main/data/Dataset_FireWatch_Brazil_2024_combined_updated.csv')
